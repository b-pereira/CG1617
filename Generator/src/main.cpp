    ...
    if(ficheiro.is_open ())
    {
        ...
        for (float i = 0; i < doisPi; i += slice)
        {
            for (i = 0; i < slices; i += slice)
            {
                ...
                ficheiro << triangle_to_string (pontoA2, pontoD, pontoD2) << endl;
                ficheiro << triangle_to_string (pontoD2, pontoD, pontoA2) << endl;
                ficheiro << triangle_to_string (pontoA2, pontoD2, pontoA) << endl;
